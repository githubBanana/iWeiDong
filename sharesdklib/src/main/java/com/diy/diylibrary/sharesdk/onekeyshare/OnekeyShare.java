...
package com.diy.diylibrary.sharesdk.onekeyshare;
...
public class OnekeyShare {
	...
	public void setWechatText(String text) {
		params.put("shareType", Platform.SHARE_TEXT);
		params.put("text", text);
	}
	public void setWechatImageUrl(String imageUrl) {
		params.put("shareType", Platform.SHARE_IMAGE);
		params.put("imageUrl", imageUrl);
