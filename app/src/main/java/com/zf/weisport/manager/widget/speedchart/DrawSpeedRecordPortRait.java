 ...
 */
public class DrawSpeedRecordPortRait extends View {
     ...
     * @param datasY
     */
    public DrawSpeedRecordPortRait(Context context, List<Integer> datasX, List<Integer> datasY) {
        super(context);
        this.datasY = datasY;
        init();
    }

    public DrawSpeedRecordPortRait(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
